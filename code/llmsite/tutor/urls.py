...
from .views import (
    ...
    dashboard_page, account_create, account_delete, student_edit, account_password_edit,
...
urlpatterns = [
    ...
    path("dashboard/change_account_password/", account_password_edit, name="account_password_edit"),
